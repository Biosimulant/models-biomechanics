...
This core model package wraps BioModels EBI `BIOMD0000000464`, the Koo2013 calcium-influx/eNOS-activation submodel. It exposes cytosolic calcium and IP3 as headline outputs plus the observed-species state needed by the parent lab.
...
| `src/koo2013_shear_stress_calcium_influx.py` | Tellurium-backed SBML execution wrapper. |
