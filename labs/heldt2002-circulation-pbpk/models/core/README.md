...
This core model package wraps BioModels EBI `MODEL1006230084`, the Heldt2002 circulation PBPK submodel. It tracks 44 rate-rule observables and exposes the stable numeric outputs required by the parent lab.
...
| `src/heldt2002_orthostaticstress_circpbpk.py` | Tellurium-backed SBML execution wrapper. |
