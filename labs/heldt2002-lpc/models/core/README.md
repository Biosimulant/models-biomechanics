...
This core model package wraps BioModels EBI `MODEL1006230113`, the Heldt2002 lumped-parameter circulation submodel. It tracks rate-rule observables and exposes headline cardiac output and mean arterial pressure outputs needed by the parent lab.

User-facing charts, summaries, and pressure-volume views live in the sibling [`../visualisation`](../visualisation/README.md) model package.
...
| `src/heldt2002_orthostaticstress_lpc.py` | Tellurium-backed SBML execution wrapper. |
