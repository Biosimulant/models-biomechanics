...
This core model package is the integrated Koo et al. (2013) endothelial mechanotransduction system from BioModels source `BIOMD0000000468`. It combines the calcium-influx and NO-production modules into one SBML wrapper named `koo2013_integrated_shear_stress_no_production`.
...
| `src/koo2013_integrated_shear_stress_no_production.py` | Tellurium-backed SBML execution wrapper. |
