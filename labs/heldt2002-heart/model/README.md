...
This model package wraps BioModels EBI `MODEL1006230103`, the Heldt2002 isolated heart submodel. It exposes the time-varying left-ventricular elastance waveform and cardiac timing helpers used by the larger circulation models.

With the bundled lab defaults, the simulator runs for 5 s and reports the elastance/timing waveform, a What Happened summary, and an LV elastance phase portrait.
...
| `src/heldt2002_orthostaticstress_heart.py` | Tellurium-backed SBML wrapper and visualization builder. |
