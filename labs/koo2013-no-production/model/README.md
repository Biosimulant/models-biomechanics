...
This model wraps the Koo et al. (2013) downstream nitric oxide production arm from BioModels source `BIOMD0000000467`. It receives cytosolic calcium as an external input and follows PI3K/AKT signalling, eNOS-complex assembly, and NO production.

The screenshots embedded in the parent lab README were validated against the visible run alias `koo2013_shear_stress_no_production`, matching this model package.
...
| `src/koo2013_shear_stress_no_production.py` | Tellurium-backed SBML wrapper and visual definitions. |
