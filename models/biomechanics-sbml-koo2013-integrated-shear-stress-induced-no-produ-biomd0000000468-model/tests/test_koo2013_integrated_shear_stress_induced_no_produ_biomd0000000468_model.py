...
"""Auto-generated tests for Koo2013IntegratedShearStressInducedNoProduBiomd0000000468Model.
...
from src.koo2013_integrated_shear_stress_induced_no_produ_biomd0000000468_model import Koo2013IntegratedShearStressInducedNoProduBiomd0000000468Model  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = Koo2013IntegratedShearStressInducedNoProduBiomd0000000468Model()
...
def test_advance_produces_outputs() -> None:
    module = Koo2013IntegratedShearStressInducedNoProduBiomd0000000468Model(min_dt=0.1)
