...
"""Auto-generated SBML BioModule wrapper for Koo2013 - Integrated shear stress induced NO production model.
...
class SbmlKoo2013IntegratedShearStressInducedNoProductionModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Koo2013 - Integrated shear stress induced NO production model."""

    def __init__(self, model_path: str = "data/BIOMD0000000468.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koo2013IntegratedShearStressInducedNoProduBiomd0000000468Model = SbmlKoo2013IntegratedShearStressInducedNoProductionModel
