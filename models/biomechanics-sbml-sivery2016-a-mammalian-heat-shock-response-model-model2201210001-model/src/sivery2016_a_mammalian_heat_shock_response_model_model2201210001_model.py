...
"""Auto-generated SBML BioModule wrapper for Sivery2016 - A mammalian heat shock response model.

Source: biomodels_ebi:MODEL2201210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2201210001
"""
...
class SbmlSivery2016AMammalianHeatShockResponseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivery2016 - A mammalian heat shock response model."""

    def __init__(self, model_path: str = "data/MODEL2201210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivery2016AMammalianHeatShockResponseModelModel2201210001Model = SbmlSivery2016AMammalianHeatShockResponseModel
