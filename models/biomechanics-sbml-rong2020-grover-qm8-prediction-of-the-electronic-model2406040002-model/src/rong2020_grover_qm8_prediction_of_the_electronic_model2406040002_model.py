...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-qm8: Prediction of the electronic spectra and excited state energy of small molecules..

Source: biomodels_ebi:MODEL2406040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2406040002
"""
...
class SbmlRong2020GroverQm8PredictionOfTheElectronicSpectra(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-qm8: Prediction of the electronic spectra and excited state energy of small molecules.."""

    def __init__(self, model_path: str = "data/MODEL2406040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverQm8PredictionOfTheElectronicModel2406040002Model = SbmlRong2020GroverQm8PredictionOfTheElectronicSpectra
