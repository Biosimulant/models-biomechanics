...
"""Auto-generated SBML BioModule wrapper for Koo2013 - Shear stress induced calcium influx and eNOS activation - Model 1.
...
class SbmlKoo2013ShearStressInducedCalciumInfluxAndEnos(biosim.BioModule):
    """BioModule wrapper for SBML model: Koo2013 - Shear stress induced calcium influx and eNOS activation - Model 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000464.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koo2013ShearStressInducedCalciumInfluxAndBiomd0000000464Model = SbmlKoo2013ShearStressInducedCalciumInfluxAndEnos
