...
"""Auto-generated SBML BioModule wrapper for Erguler2013 - Unfolded protein stress response.

Source: biomodels_ebi:BIOMD0000000446
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000446
"""
...
class SbmlErguler2013UnfoldedProteinStressResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Erguler2013 - Unfolded protein stress response."""

    def __init__(self, model_path: str = "data/BIOMD0000000446.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Erguler2013UnfoldedProteinStressResponseBiomd0000000446Model = SbmlErguler2013UnfoldedProteinStressResponse
