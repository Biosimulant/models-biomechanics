...
"""Auto-generated SBML BioModule wrapper for Heldt2002_OrthostaticStress_circpbpk.
...
class SbmlHeldt2002OrthostaticstressCircpbpk(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2002_OrthostaticStress_circpbpk."""

    def __init__(self, model_path: str = "data/MODEL1006230084.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2002OrthostaticstressCircpbpkModel1006230084Model = SbmlHeldt2002OrthostaticstressCircpbpk
