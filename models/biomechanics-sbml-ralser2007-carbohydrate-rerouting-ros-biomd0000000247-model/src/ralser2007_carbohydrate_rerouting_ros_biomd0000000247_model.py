...
"""Auto-generated SBML BioModule wrapper for Ralser2007_Carbohydrate_Rerouting_ROS.

Source: biomodels_ebi:BIOMD0000000247
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000247
"""
...
class SbmlRalser2007CarbohydrateReroutingRos(biosim.BioModule):
    """BioModule wrapper for SBML model: Ralser2007_Carbohydrate_Rerouting_ROS."""

    def __init__(self, model_path: str = "data/BIOMD0000000247.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ralser2007CarbohydrateReroutingRosBiomd0000000247Model = SbmlRalser2007CarbohydrateReroutingRos
