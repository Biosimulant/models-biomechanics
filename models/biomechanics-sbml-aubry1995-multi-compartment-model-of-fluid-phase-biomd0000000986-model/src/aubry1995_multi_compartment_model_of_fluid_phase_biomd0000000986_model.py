...
"""Auto-generated SBML BioModule wrapper for Aubry1995 - Multi-compartment model of fluid-phase endocytosis kinetics in Dictyostelium discoideum.

Source: biomodels_ebi:BIOMD0000000986
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000986
"""
...
class SbmlAubry1995MultiCompartmentModelOfFluidPhase(biosim.BioModule):
    """BioModule wrapper for SBML model: Aubry1995 - Multi-compartment model of fluid-phase endocytosis kinetics in Dictyostelium discoideum."""

    def __init__(self, model_path: str = "data/BIOMD0000000986.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aubry1995MultiCompartmentModelOfFluidPhaseBiomd0000000986Model = SbmlAubry1995MultiCompartmentModelOfFluidPhase
