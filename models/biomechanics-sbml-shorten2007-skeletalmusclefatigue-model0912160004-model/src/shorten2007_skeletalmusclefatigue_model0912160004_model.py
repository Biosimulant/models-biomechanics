...
"""Auto-generated SBML BioModule wrapper for Shorten2007_SkeletalMuscleFatigue.

Source: biomodels_ebi:MODEL0912160004
Original: https://www.ebi.ac.uk/biomodels/MODEL0912160004
"""
...
class SbmlShorten2007Skeletalmusclefatigue(biosim.BioModule):
    """BioModule wrapper for SBML model: Shorten2007_SkeletalMuscleFatigue."""

    def __init__(self, model_path: str = "data/MODEL0912160004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shorten2007SkeletalmusclefatigueModel0912160004Model = SbmlShorten2007Skeletalmusclefatigue
