...
"""Auto-generated SBML BioModule wrapper for Russomanno2023-A systems approach reveals species differences in hepatic stress response capacity-RAT_PBPK.

Source: biomodels_ebi:MODEL2307070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307070001
"""
...
class SbmlRussomanno2023ASystemsApproachRevealsSpecies(biosim.BioModule):
    """BioModule wrapper for SBML model: Russomanno2023-A systems approach reveals species differences in hepatic stress response capacity-RAT_PBPK."""

    def __init__(self, model_path: str = "data/MODEL2307070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Russomanno2023ASystemsApproachRevealsSpecieModel2307070001Model = SbmlRussomanno2023ASystemsApproachRevealsSpecies
