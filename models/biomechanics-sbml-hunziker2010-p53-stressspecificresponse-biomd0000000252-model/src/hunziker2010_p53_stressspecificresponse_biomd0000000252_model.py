...
"""Auto-generated SBML BioModule wrapper for Hunziker2010_p53_StressSpecificResponse.

Source: biomodels_ebi:BIOMD0000000252
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000252
"""
...
class SbmlHunziker2010P53Stressspecificresponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Hunziker2010_p53_StressSpecificResponse."""

    def __init__(self, model_path: str = "data/BIOMD0000000252.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hunziker2010P53StressspecificresponseBiomd0000000252Model = SbmlHunziker2010P53Stressspecificresponse
