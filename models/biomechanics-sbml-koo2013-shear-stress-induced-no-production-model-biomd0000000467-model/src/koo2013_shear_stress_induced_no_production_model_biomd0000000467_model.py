...
"""Auto-generated SBML BioModule wrapper for Koo2013 - Shear stress induced NO production - Model 4.
...
class SbmlKoo2013ShearStressInducedNoProductionModel4(biosim.BioModule):
    """BioModule wrapper for SBML model: Koo2013 - Shear stress induced NO production - Model 4."""

    def __init__(self, model_path: str = "data/BIOMD0000000467.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koo2013ShearStressInducedNoProductionModelBiomd0000000467Model = SbmlKoo2013ShearStressInducedNoProductionModel4
