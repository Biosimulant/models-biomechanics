...
"""Auto-generated SBML BioModule wrapper for Soleimani2019 - Finite-element model of incudostapedial joint.

Source: biomodels_ebi:MODEL1905070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1905070001
"""
...
class SbmlSoleimani2019FiniteElementModelOfIncudostapedialJoint(biosim.BioModule):
    """BioModule wrapper for SBML model: Soleimani2019 - Finite-element model of incudostapedial joint."""

    def __init__(self, model_path: str = "data/MODEL1905070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Soleimani2019FiniteElementModelOfIncudostapModel1905070001Model = SbmlSoleimani2019FiniteElementModelOfIncudostapedialJoint
