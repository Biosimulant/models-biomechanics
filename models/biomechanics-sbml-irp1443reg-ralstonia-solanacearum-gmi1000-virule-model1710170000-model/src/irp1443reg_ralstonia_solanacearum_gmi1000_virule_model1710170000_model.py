...
"""Auto-generated SBML BioModule wrapper for iRP1443REG - Ralstonia solanacearum GMI1000 Virulence regulatory network.

Source: biomodels_ebi:MODEL1710170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1710170000
"""
...
class SbmlIrp1443regRalstoniaSolanacearumGmi1000Virulence(biosim.BioModule):
    """BioModule wrapper for SBML model: iRP1443REG - Ralstonia solanacearum GMI1000 Virulence regulatory network."""

    def __init__(self, model_path: str = "data/MODEL1710170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Irp1443regRalstoniaSolanacearumGmi1000ViruleModel1710170000Model = SbmlIrp1443regRalstoniaSolanacearumGmi1000Virulence
