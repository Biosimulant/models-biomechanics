...
"""Auto-generated SBML BioModule wrapper for Heldt2002_OrthostaticStress_heart.
...
class SbmlHeldt2002OrthostaticstressHeart(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2002_OrthostaticStress_heart."""

    def __init__(self, model_path: str = "data/MODEL1006230103.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2002OrthostaticstressHeartModel1006230103Model = SbmlHeldt2002OrthostaticstressHeart
